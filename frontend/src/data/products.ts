...
export const products: Product[] = [
  // SECTION 1: AZURE INFRASTRUCTURE (isAzureResource: true)
  {
    id: 'azure-vm',
  ...
  // SECTION 2: PHYSICAL DEVELOPER ACCESSORIES / GEAR (with hotlinked images)
  {
